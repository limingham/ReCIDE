...
prd_df <- readRDS("~/ReCIDE/应用_前二_新_inter/SLE/scdc/SCDC_prd_df.rds")
prd_df=prd_df[,sort(colnames(prd_df))]

metadata<- readRDS("~/ReCIDE/应用_前二_新/SLE/bulkdata/GSE50772_meta.rds")
...
# plot_data=subset(plot_data,MAIT>0)
