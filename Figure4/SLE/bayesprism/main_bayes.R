...
bulk.mtx<- readRDS("~/ReCIDE/应用_前二/应用_SLE/bulkdata/GSE50772_exprs.rds")
...
saveRDS(bp.res,file = '~/ReCIDE/应用_前二_新_inter/SLE/bayesprism_benchmark/Bayes_output.rds')

saveRDS(theta,file = '~/ReCIDE/应用_前二_新_inter/SLE/bayesprism_benchmark/Bayes_prd_df.rds')



Bayes_prd_df <- readRDS("~/ReCIDE/应用_前二_新_inter/SLE/bayesprism_benchmark/Bayes_prd_df.rds")
# row.names(Bayes_prd_df)=names(EXP)
Bayes_prd_df=as.data.frame(t(Bayes_prd_df))
saveRDS(Bayes_prd_df,file="~/ReCIDE/应用_前二_新_inter/SLE/bayesprism_benchmark/Bayes_prd_df.rds")
