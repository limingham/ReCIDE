...
EXP_combine <- readRDS("~/ReCIDE/应用_前二_新_inter/COVID19/bulkdata/counts_data_query.rds")
...
saveRDS.lbzip2(combined.data.sub,file = '~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/ref_150.rdsFS',n.cores = 100)
...
combined.data.sub=readRDS.lbzip2('~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/ref_150.rdsFS',n.cores = 200)
# 
...
saveRDS(ref_list.FC_screen, file="~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/ref_sep_names.FC_screen.rds")
...
# EXP=2^EXP-1
Sig_list<- readRDS("~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/PBMC_sep_sig.rds")
...
saveRDS(sep_solDWLS,file='~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/结果/DWLS_output_LowToHigh_PCA.rds')

sep_solDWLS<- readRDS("~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/结果/DWLS_output_LowToHigh_PCA.rds")
...
saveRDS(prd_after,file='~/ReCIDE/应用_前二_新_inter/sep_ref_inter_COVID2/结果/prd_sep_LowToHigh_PCA.rds')
