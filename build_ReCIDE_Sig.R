...
Build_ReCIDE_Sig<-function(SC_ref_sub,EXP_df,
  ...
  sc_ref_list<-SplitObject(SC_ref_sub,split.by = 'label_subject')##############
  ...
  func_findf<-function(il){
    ...
    scdata_test@meta.data[["usetype"]]<-scdata_test@meta.data[["label_celltype"]]###########
