...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/cibersort_sep/sep_CIBERSORT_output_HighToLow.rds')
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/cibersort_sep/sep_CIBERSORT_output_LowToHigh.rds')
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/cibersort_sep/sep_CIBERSORT_output_GA.rds')
...
sep_solDWLS <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/cibersort_sep/sep_CIBERSORT_output_LowToHigh.rds")
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/cibersort_sep/prd_df.rds')
