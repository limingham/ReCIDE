...
saveRDS(FARDEEP_results,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/fardeep_com/FARDEEP_com_output.rds')




prd<- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/fardeep_com/FARDEEP_com_output.rds")
...
saveRDS(prd_com,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/fardeep_com/prd_com_df.rds')
