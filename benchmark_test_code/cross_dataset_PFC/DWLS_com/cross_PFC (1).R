...
scdata_test=readRDS.lbzip2(file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/ref_data/ref_all.rdsFS',n.cores = 200)
EXP<- readRDS("~/ReCIDE/benchmark测试/cross_dataset_PFC/EXP_and_key/EXP_PFC.rds")

rn=intersect(row.names(scdata_test),names(EXP[[1]]))
scdata_test=scdata_test[rn,]



scdata_test@meta.data[["usetype"]]<-scdata_test@meta.data[["major.celltype"]]###########
...
saveRDS(Sig,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/DWLS_com/PFC_com_sig.rds')
...
Sig_list <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/DWLS_com/PFC_com_sig.rds")
...
saveRDS(sep_solDWLS,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/DWLS_com/DWLS_com_output.rds')
...
saveRDS(prd_com,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PFC/DWLS_com/prd_com_PFC.rds')