...
deone_PAN <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/deone_PAN.rds")
deone_kidney <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/deone_kidney.rds")
cross_PFC <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/cross_PFC.rds")
cross_PBMC <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/cross_PBMC.rds")
mult_PBMC <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/mult_PBMC.rds")
mult_ER <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/mult_ER.rds")
high_res_TNBC <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/high_res_TNBC.rds")
high_res_CRC <- readRDS("~/ReCIDE/benchmark测试_最终/绘制Figure1_优化前后比较_RMSE/plotdata/high_res_CRC.rds")
