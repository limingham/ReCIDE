...
source("~/ReCIDE/benchmark测试_最终/tutorial绘制图/绘制Figure1_箱线图_RMSE/deone_kidney/main_deone_kidney.R")
...
source("~/ReCIDE/benchmark测试_最终/tutorial绘制图/绘制Figure1_箱线图_RMSE/deone_PAN/main_deone_PAN.R")
plot_data2=subset(plot_data,methods %in% c('BayesPrism',
                                           ...
                                           "MuSiC",
                                           "SCDC"))
plot_data2[,'datasets']='deone_PAN'


source("~/ReCIDE/benchmark测试_最终/tutorial绘制图/绘制Figure1_箱线图_RMSE/cross_PFC/main_cross_PFC.R")
...
source("~/ReCIDE/benchmark测试_最终/tutorial绘制图/绘制Figure1_箱线图_RMSE/cross_PBMC/main_cross_PBMC.R")
...
for (i in 1:nrow(plot_data)) {
  if(plot_data[i,'datasets'] == "deone_kidney"){
    plot_data[i,'datasets2']='Kidney'
  }
  if(plot_data[i,'datasets'] == "deone_PAN"){
    plot_data[i,'datasets2']='PAN'
  }
  if(plot_data[i,'datasets'] == "cross_PFC"){
    plot_data[i,'datasets2']='PFC'
  }
