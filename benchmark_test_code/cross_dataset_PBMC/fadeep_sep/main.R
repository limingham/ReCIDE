...
sep_ref.list <- readRDS("~/SWORD/其他模型benchmark测试_最终/参考marker基因矩阵/sep/PBMC_sep_ref.rds")
...
func_FARDEEP<-function(i){
  ...
  names(FD_results_in)<-names(sep_ref.list)
...
saveRDS(FARDEEP_results,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/fadeep_sep/FARDDEP_sep_output_LowToHigh.rds')
...
library(FARDEEP)
####sepPFC
sep_ref.list <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/ref_data/PBMC_sep_sig.rds")
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/fadeep_sep/FARDDEP_sep_output_LowToHigh.rds')




sep_solDWLS <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/fadeep_sep/FARDDEP_sep_output_LowToHigh.rds")
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/fadeep_sep/prd_sep_LowToHigh_PCA.rds')
