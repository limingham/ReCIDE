...
scdata_test=readRDS.lbzip2(file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/ref_data/ref_all.rdsFS',n.cores = 200)
...
scdata_test@meta.data[["usetype"]]<-scdata_test@meta.data[["cg_cov"]]###########
...
saveRDS(Sig,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_com/PFC_com_sig.rds')
...
Sig_list <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_com/PFC_com_sig.rds")
...
saveRDS(sep_solDWLS,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_com/DWLS_com_output.rds')
...
saveRDS(prd_com,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_com/prd_com_PBMC.rds')
