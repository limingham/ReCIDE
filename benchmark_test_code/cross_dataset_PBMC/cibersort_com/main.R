...
saveRDS(com_results,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/cibersort_com/CIBEROSRT_com_output.rds')




cibersort_com_result <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/cibersort_com/CIBEROSRT_com_output.rds")
...
saveRDS(prd_com,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/cibersort_com/prd_com_df.rds')
