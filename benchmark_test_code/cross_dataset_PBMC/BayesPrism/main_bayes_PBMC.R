...
ref_seurat<-readRDS.lbzip2(file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/ref_data/ref_all.rdsFS',n.cores = 200)
...
###参考集构建
####celltype
cell.type.labels<-ref_seurat@meta.data['cg_cov']
...
saveRDS(bp.res,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/BayesPrism/Bayes_output.rds')

saveRDS(theta,file = '~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/BayesPrism/Bayes_prd_df.rds')



Bayes_prd_df <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/BayesPrism/Bayes_prd_df.rds")
row.names(Bayes_prd_df)=names(EXP)
Bayes_prd_df=as.data.frame(t(Bayes_prd_df))
saveRDS(Bayes_prd_df,file="~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/BayesPrism/Bayes_prd_df.rds")
