...
Sig_list <- readRDS("~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_sep/PBMC_sep_sig.rds")
...
saveRDS(sep_solDWLS,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_sep/DWLS_sep_output_LowToHigh.rds')
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/cross_dataset_PBMC/DWLS_sep/prd_sep_LowToHigh_PCA.rds')
# 
# rm(list=ls())
# gc()
