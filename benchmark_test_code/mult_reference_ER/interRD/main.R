...
library(SCDC)
library(COSG)
combined.data<-readRDS.lbzip2(file='~/ReCIDE/benchmark测试_最终/mult_reference_ER新/Seurat_78_29.rdsFS',n.cores = 200)
EXP_combine  <- readRDS("~/ReCIDE/benchmark测试/mult_reference_ER新/EXP_and_KEY/EXP.rds")

combined.data@meta.data[,'usetype']=combined.data@meta.data[,'Major_celltype']

combined.data@meta.data[combined.data@meta.data[,'usetype']=='Epithelial','usetype']=combined.data@meta.data[combined.data@meta.data[,'usetype']=='Epithelial','Minor_celltype']
...
cell_id=as.data.frame(table(combined.data@meta.data[["usetype"]]))
cell_id=cell_id[cell_id[,2]>20,]
combined.data<-subset(combined.data,usetype %in% cell_id[,1])
...
ref_com.FC_screen <- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_ER新/DWLS_com/ER_com_sig.rds")
...
saveRDS(marker_list,file = '~/ReCIDE/benchmark测试_最终/mult_reference_ER新/interRD/marker_list.rds')




SCDC_output <- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_ER新/scdc/SCDC_output.rds")
marker_list <- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_ER新/interRD/marker_list.rds")
...
# save(bulk.mtx,marker_list,unique_cell_type,ref_data,file='~/ReCIDE/benchmark测试/mult_reference_ER新/interRD/data2.rdata')


saveRDS(InteRD1.output_in,file = '~/ReCIDE/benchmark测试_最终/mult_reference_ER新/interRD/interRD1_output.rds')
...
saveRDS(InteRD1_results,file = '~/ReCIDE/benchmark测试_最终/mult_reference_ER新/interRD/interRD1_prop_df.rds')
