...
####comPBMC
com_ref <- readRDS("~/ReCIDE/benchmark测试_最终/high_res_TNBC/ref_data/ref_com.FC_screen.rds")
...
saveRDS(FARDEEP_results,file = '~/ReCIDE/benchmark测试_最终/high_res_TNBC/fardeep_com/FARDEEP_com_output.rds')
