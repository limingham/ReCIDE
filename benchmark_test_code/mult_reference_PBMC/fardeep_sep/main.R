...
saveRDS(FARDEEP_results,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/fardeep_sep/FARDDEP_sep_output_LowToHigh.rds')
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/fardeep_sep/FARDDEP_sep_output_LowToHigh.rds')



sep_solDWLS<- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/fardeep_sep/FARDDEP_sep_output_LowToHigh.rds")
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/fardeep_sep/prd_sep_LowToHigh_PCA2.rds')
