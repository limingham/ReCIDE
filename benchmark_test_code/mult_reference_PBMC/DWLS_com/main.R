...
scdata_test=readRDS.lbzip2(file='~/ReCIDE/benchmark测试/mult_reference_PBMC/ref_data/ref_all.rdsFS',n.cores = 200)
...
# Sig <- as.data.frame(lapply(Sig, as.numeric))
Sig <- dplyr::mutate_all(Sig, as.numeric)
saveRDS(Sig,file = '~/ReCIDE/benchmark测试/mult_reference_PBMC/DWLS_com/DWLS_tutorial/PBMC_com_sig.rds')
...
Sig_list <- readRDS("~/ReCIDE/benchmark测试/mult_reference_PBMC/DWLS_com/DWLS_tutorial/PBMC_com_sig.rds")
...
saveRDS(sep_solDWLS,file='~/ReCIDE/benchmark测试/mult_reference_PBMC/DWLS_com/DWLS_tutorial/DWLS_com_output.rds')
...
saveRDS(prd_com,file='~/ReCIDE/benchmark测试/mult_reference_PBMC/DWLS_com/DWLS_tutorial/prd_com_PBMC.rds')
