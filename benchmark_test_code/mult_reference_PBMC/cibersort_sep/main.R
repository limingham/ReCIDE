...
####sepPFC
sep_ref.list<- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/ref_data/PBMC_sep_sig.rds")
EXP<- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/EXP_and_KEY/EXP_PBMC.rds")
source("~/SWORD/其他模型benchmark测试_最终/CIBERSORT_results/Cibersort.R")
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/cibersort_sep/sep_CIBERSORT_output_HighToLow.rds')
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/cibersort_sep/sep_CIBERSORT_output_LowToHigh.rds')
...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/cibersort_sep/sep_CIBERSORT_output_GA.rds')
...
sep_solDWLS<- readRDS("~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/cibersort_sep/sep_CIBERSORT_output_LowToHigh.rds")
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/mult_reference_PBMC/cibersort_sep/prd_sep_LowToHigh_PCA2.rds')
