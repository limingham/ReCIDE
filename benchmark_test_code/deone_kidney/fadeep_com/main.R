...
####comPBMC
com_ref <- readRDS("~/ReCIDE/benchmark测试_最终/deone_kidney/ref_data/ref_com.FC_screen.rds")
...
# save(FARDEEP_results,file = '~/ReCIDE/benchmark测试_最终/deone_kidney/fadeep_com/FARDEEP_com_output.RData')

saveRDS(FARDEEP_results,file = '~/ReCIDE/benchmark测试_最终/deone_kidney/fadeep_com/FARDEEP_com_output.rds')



prd<- readRDS("~/ReCIDE/benchmark测试_最终/deone_kidney/fadeep_com/FARDEEP_com_output.rds")
...
saveRDS(prd_com,file = '~/ReCIDE/benchmark测试_最终/deone_kidney/fadeep_com/prd_df.rds')
