...
saveRDS(com_results,file='~/ReCIDE/benchmark测试_最终/deone_kidney/cibersort_com/CIBEROSRT_com_output.rds')





cibersort_com_result <- readRDS("~/ReCIDE/benchmark测试_最终/deone_kidney/cibersort_com/CIBEROSRT_com_output.rds")
##comprd结果整合
...
saveRDS(prd_com,file = '~/ReCIDE/benchmark测试_最终/deone_kidney/cibersort_com/prd_com_df.rds')
