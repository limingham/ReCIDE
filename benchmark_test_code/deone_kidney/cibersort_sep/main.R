...
saveRDS(sep_solFAR,file='~/ReCIDE/benchmark测试_最终/deone_kidney/cibersort_sep/sep_CIBERSORT_output_LowToHigh.rds')




sep_solDWLS <- readRDS("~/ReCIDE/benchmark测试_最终/deone_kidney/cibersort_sep/sep_CIBERSORT_output_LowToHigh.rds")
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/deone_kidney/cibersort_sep/prd_df.rds')
