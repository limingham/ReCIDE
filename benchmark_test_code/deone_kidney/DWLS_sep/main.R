...
Sig_list <- readRDS("~/ReCIDE/benchmark测试_最终/deone_kidney/DWLS_sep/Sig_ref_list_all.rds")
...
saveRDS(sep_solDWLS,file='~/ReCIDE/benchmark测试_最终/deone_kidney/DWLS_sep/DWLS_sep_output_LowToHigh.rds')
...
saveRDS(prd_after,file='~/ReCIDE/benchmark测试_最终/deone_kidney/DWLS_sep/prd_sep_LowToHigh_PCA.rds')
