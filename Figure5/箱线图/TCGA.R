...
# data_matrix[,'CX_PVL']<-data_matrix[,'CXCL13']*data_matrix[,'PVLs3']/data_matrix[,'PVL']^2
...
data_matrix[,'datasets']='TCGA'

saveRDS(data_matrix,file='~/ReCIDE/应用_TNBC/论文中结果/箱线图/TCGA.rds')
