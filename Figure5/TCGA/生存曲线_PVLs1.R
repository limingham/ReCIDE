...
prd_after<- readRDS("~/ReCIDE/应用_TNBC/论文中结果/TCGA/prd_sep_init.rds")
# prd_after<- readRDS("~/ReCIDE/应用_TNBC/论文中结果/TCGA/prd_sep_30.rds")
...
# pvl_all=prd_after['PVL_Immature_s1',]
# pvl_all= prd_after['T_cells_c3_CD4__Tfh_CXCL13',]
...
##<=的话小于的被cut掉，成为TRUE
qn1=quantile(as.numeric(gene_exp2[,1]),0.15)
qn2=quantile(as.numeric(gene_exp2[,1]),0.85)
