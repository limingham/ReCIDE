...
###其他细胞类型是细胞类型数大于30
###PVLs1是原始前15%，后15%
sep_solDWLS<- readRDS("~/ReCIDE/应用_TNBC/论文中结果/TCGA/DWLS_output_ref50.rds")
...
saveRDS(prd_after,file='~/ReCIDE/应用_TNBC/论文中结果/TCGA/prd_sep_init.rds')
...
saveRDS(prd_after,file='~/ReCIDE/应用_TNBC/论文中结果/TCGA/prd_sep_30.rds')
